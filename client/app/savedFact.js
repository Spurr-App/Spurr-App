    ...
    switch (service) {
      case 'facebook': {
        const fbURL = `http://www.facebook.com/dialog/feed?app_id=${1767308383585120}` +
          `&link=${encodeURIComponent('spurr.real-deal.studio')}&picture=http://i.imgur.com/Ej3LoGC.png` +
      ...
      case 'twitter': {
        const twitURL = `https://twitter.com/share?url=${'https://spurr.real-deal.studio'}` +
